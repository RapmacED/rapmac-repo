...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/raph/Documents/rapmac-repo/perso/openAI/deactivate'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/raph/Documents/rapmac-repo/perso/openAI/deactivate/bin/deactivate.nu'
